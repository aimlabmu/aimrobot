...
data_root = '/workspace/fast_data_1/data/synth_cards/sdr_nohuman_prototype/'
classes = (
...
train_dataset = dict(
    ...
    dataset=dict(
        ...
        ann_file=
        '/workspace/fast_data_1/data/synth_cards/sdr_nohuman_prototype/instances_train.json',
        img_prefix=
        '/workspace/fast_data_1/data/synth_cards/sdr_nohuman_prototype/RGBd6693b1e-19b5-4463-b68c-f352774fcf90',
        pipeline=[
...
work_dir = './work_dirs/yolox_s_8x8_300e_nohuman2real_card_detection'
auto_resume = False
gpu_ids = [0]
