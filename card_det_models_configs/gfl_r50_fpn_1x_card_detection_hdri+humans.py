...
data = dict(
    ...
    test=dict(
        type='CocoDataset',
        ann_file=
        '/workspace/fast_data_1/data/synth_cards/card_eval_set_1/card_eval_set_1_coco-human.json',
        img_prefix='/workspace/fast_data_1/data/synth_cards/card_eval_set_1/images',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                tags=['resnet50', 'sgd', 'gfl', 'full-human']),
            interval=10,
            log_checkpoint=True,
...
work_dir = './work_dirs/gfl_r50_fpn_1x_card_detection'
auto_resume = False
gpu_ids = [0]
