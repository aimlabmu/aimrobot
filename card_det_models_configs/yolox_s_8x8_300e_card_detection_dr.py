...
log_level = 'INFO'
load_from = 'pretrained_models/yolox_s_8x8_300e_coco_20211121_095711-4592a793.pth'
resume_from = None
workflow = [('train', 1)]
...
model = dict(
    ...
    neck=dict(
        ...
        num_csp_blocks=1),
    bbox_head=dict(
        type='YOLOXHead', num_classes=213, in_channels=128, feat_channels=128),
    train_cfg=dict(assigner=dict(type='SimOTAAssigner', center_radius=2.5)),
    test_cfg=dict(score_thr=0.01, nms=dict(type='nms', iou_threshold=0.65)))
dataset_type = 'CocoDataset'
data_root = '/workspace/ssd_data_1/data/synth_cards/unity_cards_dr_40k/'
classes = (
...
train_dataset = dict(
    ...
    dataset=dict(
        ...
        ann_file=
        '/workspace/ssd_data_1/data/synth_cards/unity_cards_dr_40k/coco_labels.json',
        img_prefix=
        '/workspace/ssd_data_1/data/synth_cards/unity_cards_dr_40k/RGBca1a7718-5d2f-4240-b0e6-603a8c3092c1',
        pipeline=[
...
data = dict(
    ...
    val=dict(
        ...
        classes=(
            ...
            'takeapoo', 'washmyhair', 'washmyhand'),
        ann_file=
        '/workspace/ssd_data_1/data/synth_cards/cardBox/robot_card_test_coco.json',
        img_prefix='/workspace/ssd_data_1/data/synth_cards/cardBox',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
    ...
    test=dict(
        ...
        classes=(
            ...
            'takeapoo', 'washmyhair', 'washmyhand'),
        ann_file=
        '/workspace/ssd_data_1/data/synth_cards/cardBox2/label_pzaw.json',
        img_prefix='/workspace/ssd_data_1/data/synth_cards/cardBox2',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
work_dir = './work_dirs/yolox_s_8x8_300e_card_detection_dr'
auto_resume = False
gpu_ids = [0]
