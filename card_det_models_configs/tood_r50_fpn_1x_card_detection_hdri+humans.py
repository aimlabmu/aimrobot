    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='mmdetection',
                entity='bpninja',
                config=dict(lr=0.0001, batch_size=32),
                tags=['resnet50', 'sgd', 'tood', 'full-human']),
            interval=10,
            log_checkpoint=True,
...
log_level = 'INFO'
load_from = 'pretrained_models/tood_r50_fpn_1x_coco_20211210_103425-20e20746.pth'
resume_from = None
workflow = [('train', 1)]
...
work_dir = './work_dirs/tood_r50_fpn_1x_card_detection'
auto_resume = False
gpu_ids = [0]
