    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                tags=['darknet53', 'sgd', 'yolox-m', 'human']),
            interval=10,
            log_checkpoint=True,
...
model = dict(
    ...
    neck=dict(
        ...
        num_csp_blocks=2),
    bbox_head=dict(
        type='YOLOXHead', num_classes=214, in_channels=192, feat_channels=192),
...
work_dir = './work_dirs/yolox_m_8x8_300e_human_card_detection'
auto_resume = False
gpu_ids = [0]
