...
model = dict(
    ...
    neck=dict(
        ...
        num_csp_blocks=1),
    bbox_head=dict(
        type='YOLOXHead', num_classes=214, in_channels=128, feat_channels=128),
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            classes=(
                ...
                'washmyhair', 'washmyhand', 'person'),
            ann_file=
            '/workspace/fast_data_1/data/synth_cards/cards_hdr/coco_labels.json',
            img_prefix=
            '/workspace/fast_data_1/data/synth_cards/cards_hdr/images/',
            pipeline=[
                dict(type='LoadImageFromFile'),
                dict(type='LoadAnnotations', with_bbox=True)
            ],
...
work_dir = './work_dirs/yolox_s_8x8_300e_card_detection'
auto_resume = False
gpu_ids = [0]
